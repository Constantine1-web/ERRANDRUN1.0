...
const targetPath = path.join(process.cwd(), 'src/app/dashboard/runner/accepted/[id]/page.tsx');
...
console.log('Successfully refactored AcceptedMissionPage to match Mission Control aesthetics!');

...
export function RunnerLogo({ className = 'w-16 h-16', animate = true }: RunnerLogoProps) {
  ...
  const speedLineVariants = {
    ...
    visible: (custom: number) => ({
      ...
      opacity: 1,
      x: 0,
      transition: { delay: 0.5 + custom * 0.2, duration: 0.6, ease: "easeOut" }
    })
  };
  ...
  return (
    ...
    >
      ...
      {/* --- RUNNER FIGURE (Brand Light Blue) --- */}

...
export default function UserDashboardContent() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-8 space-y-8 animate-fadeIn">
      ...
      <section className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/90 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-100 text-emerald-800 border border-emerald-200/60 flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-600 animate-ping"></span>
                Campus Runners Active
              </span>
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-3 pr-4 flex items-center gap-3">
      ...
      {/* ── FAST INTENT LAUNCHPAD ── */}
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-base font-bold text-slate-900 tracking-tight uppercase tracking-wider text-xs">
          ...
          {intentCategories.map((cat) => {
            ...
            return (
              <div
                ...
                className="bg-white hover:bg-blue-50/20 border border-slate-200/80 hover:border-blue-300 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-sm group flex flex-col justify-between space-y-4"
              >
                <div className="flex items-start justify-between">
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center border ${cat.color} group-hover:scale-105 transition-transform`}>

...
function ErrandBookingContent() {
  ...
  const categories = [
    ...
    { id: 'other', title: 'Others', icon: MoreHorizontal },
  ];
        ...
        <div className="lg:col-span-7 space-y-5">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border border-slate-200/90 dark:border-slate-800 shadow-sm space-y-4">
            <h2 className="text-sm font-black uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
              <Navigation className="w-3.5 h-3.5 text-student-charcoal dark:text-student-icy" />
              1. Delivery Route
            </h2>
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <div className="w-3 h-3 rounded-full bg-student-charcoal absolute left-3.5 top-1/2 -translate-y-1/2" />
                  <input
                    type="text"
                ...
                <Button
                  ...
                  className="text-xs font-bold shrink-0 border-slate-300 dark:border-slate-700 h-11 gap-1"
                >
                  <MapPin className="w-3.5 h-3.5 text-student-charcoal dark:text-student-icy" />
            ...
            {hasLockedCoordinates ? (
              <div className="p-3.5 rounded-2xl bg-student-icy/20 dark:bg-blue-950/60 border border-student-icy/40 dark:border-blue-800 flex items-center justify-between text-xs animate-fadeIn">
                <div className="space-y-0.5">
                  <span className="text-[10px] font-black uppercase tracking-wider text-student-charcoal dark:text-student-icy dark:text-student-icy flex items-center gap-1">
                    <Zap className="w-3.5 h-3.5 text-student-charcoal dark:text-student-icy dark:text-student-icy" />
              ...
              <div className="flex flex-wrap gap-1.5">
                {quickLandmarks.map((lm) => (
                  <button
                    ...
                    className="px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-student-icy/20 dark:hover:bg-slate-700 text-[11px] font-semibold text-slate-700 dark:text-slate-300 hover:text-student-charcoal dark:text-student-icy transition-colors"
                  >
                    {lm.label}
                  </button>
                ))}
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border border-slate-200/90 dark:border-slate-800 shadow-sm space-y-4">
            <h2 className="text-sm font-black uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
              <Package className="w-3.5 h-3.5 text-student-charcoal dark:text-student-icy" />
              2. Items & Details
            </h2>
                ...
                return (
                  <button
                    ...
                    className={`p-3 rounded-xl border text-center flex flex-col items-center gap-1.5 transition-all ${
                      active
                        ? 'border-student-charcoal bg-student-icy/20 dark:bg-blue-950 text-student-charcoal dark:text-student-icy dark:text-blue-300 font-bold shadow-sm ring-1 ring-blue-500'
        ...
        <div className="lg:col-span-5 sticky top-20 space-y-4">
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/90 dark:border-slate-800 shadow-xl space-y-5">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
              ...
              <span className="text-xs font-bold text-student-charcoal dark:text-student-icy dark:text-student-icy bg-student-icy/20 dark:bg-blue-950 px-2.5 py-1 rounded-full">

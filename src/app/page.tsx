          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="bg-slate-50 dark:bg-[#121824] rounded-[2rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm relative text-center overflow-hidden flex flex-col items-center">
                ...
                {step.image && (
                  <div className="absolute inset-0 z-0 opacity-[0.08] dark:opacity-10 mix-blend-multiply dark:mix-blend-screen pointer-events-none flex justify-center items-center">
                    <img 
                      src={step.image} 
                      alt={step.title} 
                      className="w-full h-full object-cover scale-150 invert hue-rotate-180 dark:invert-0 dark:hue-rotate-0" 
                      style={{ 
